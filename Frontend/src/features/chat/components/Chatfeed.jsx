...
const EmptyState = () => (
  ...
  >
    ...
    >
      ...
      >
        <PerplexityLogo size={52} className="text-white/20" />
      </motion.div>
      ...
      <motion.h1
        ...
        className="text-white/80 font-medium select-none"
        style={{
    ...
    <motion.p
      ...
      className="mt-4 text-white/20 text-sm"
